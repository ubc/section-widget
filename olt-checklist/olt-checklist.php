	...
	*/
		...
		switch ( $mode ) {
			case 'special-pages':
				$defaults = array(
					'selected' => array(),
					'echo'     => 1,
					'id'       => 'olt-checklist-special-pages',
					'name'     => 'olt-checklist-special-pages',
					'exclude'  => array(),
				);
				$data     = array(
					(object) array(
					...
					(object) array(
						'parent'      => 0,
						'id'          => 'home',
						'name'        => __( 'Posts page', 'section-widget' ),
					...
					(object) array(
						'parent'      => 0,
						'id'          => 'category',
						'name'        => __( 'Selected Category Archive Pages', 'section-widget' ),
					...
					(object) array(
						'parent'      => 0,
						'id'          => 'tag',
						'name'        => __( 'Selected Tag Archive Pages', 'section-widget' ),
					...
					(object) array(
						'parent'      => 0,
						'id'          => 'page',
						'name'        => __( 'All Pages', 'section-widget' ),
						'description' => __( 'Display this widget on all pages.', 'section-widget' ),
					),
					(object) array(
						'parent'      => 0,
						'id'          => 'post',
						'name'        => __( 'All Post', 'section-widget' ),
						'description' => __( 'Display this widget on all posts.', 'section-widget' ),
					),
					(object) array(
						'parent'      => 0,
						'id'          => 'comment',
						'name'        => __( 'Commentable Pages/Posts', 'section-widget' ),
						'description' => __( 'Display this widget on all pages/posts where comments are allowed.', 'section-widget' ),
					),
					(object) array(
						'parent'      => 0,
						'id'          => 'author',
						'name'        => __( 'Author Pages', 'section-widget' ),
						'description' => __( 'Display this widget on all author pages.', 'section-widget' ),
					),
					(object) array(
						'parent'      => 0,
						'id'          => 'search',
						'name'        => __( 'Search Results', 'section-widget' ),
						'description' => __( 'Display this widget on all search result pages.', 'section-widget' ),
					),
					(object) array(
						'parent'      => 0,
						'id'          => 'notfound',
						'name'        => __( '&quot;Not Found&quot; Pages', 'section-widget' ),
						'description' => __( 'Display this widget when a requested page cannot be found.', 'section-widget' ),
					),
					...
					if ( $type->publicly_queryable ) :
						array_push(
							...
							(object) array(
								'parent'      => 0,
								'id'          => 'cpts-' . $post_type,
								'name'        => __( 'All ', 'section-widget' ) . $type->labels->name,
								'description' => __( 'Display this widget on all ', 'section-widget' ) . $type->labels->name . __( ' single pages', 'section-widget' ),
							)
						);
						if ( $type->has_archive ) :
							array_push(
								...
								(object) array(
									'parent'      => 0,
									'id'          => 'cpta-' . $post_type,
									'name'        => $type->labels->name . __( ' Archive Pages', 'section-widget' ),
									'description' => __( 'Display this widget on all ', 'section-widget' ) . $type->labels->name . __( ' archive pages', 'section-widget' ),
								)
							);
						endif;
					endif;
				...
				foreach ( $taxonomies as $taxonomie ) :
					...
					array_push(
						...
						(object) array(
							'parent'      => 0,
							'id'          => 'cta--' . $taxonomie,
							'name'        => __( 'All ', 'section-widget' ) . $tax->labels->name . __( ' Archive Pages', 'section-widget' ),
							'description' => __( 'Display this widget on all ', 'section-widget' ) . $type->labels->name . __( ' taxonomy archive pages', 'section-widget' ),
						)
					);
			...
			case 'categories':
				$defaults = array(
					'selected' => array(),
					'echo'     => 1,
					'id'       => 'olt-checklist-categories',
					'name'     => 'olt-checklist-categories',
				);
			...
			case 'tags':
				$defaults = array(
					'selected' => array(),
					'echo'     => 1,
					'id'       => 'olt-checklist-tags',
					'name'     => 'olt-checklist-tags',
				);
			...
			default:
				$defaults = array(
					'selected' => array(),
					'echo'     => 1,
					'id'       => 'olt-checklist-pages',
					'name'     => 'olt-checklist-pages',
				);
			...
			switch ( $key ) {
				...
				case 'tag':
					$ts = get_tags(
						array(
							'hide_empty' => false,
							'include'    => implode( ',', $conditions['tags'] ),
						)
					);
					if ( is_tag(
						array_map(
	...
	class OLTSpecialPagesChecklistWalker extends Walker {
		...
		function start_el( &$output, $special_page, $depth = 0, $args = array(), $current_object_id = 0 ) {
			...
			if ( in_array( $special_page->id, $exclude ) ) {
				return;
			}
